...
public class TestingDataUtils {
    private static final String testingJson = "[\n" +
            "  {\n" +
            "    \"id\": 1,\n" +
            "    \"name\": \"Nutella Pie\",\n" +
            "    \"ingredients\": [\n" +
    ...
    public static List<Recipe> GetRecipes(){
        if(Recipes==null) {
            ...
            Recipes = gson.fromJson(testingJson, new TypeToken<List<Recipe>>() {
            }.getType());
        }
        return Recipes;
    }

    /// Method used from https://stackoverflow.com/questions/41996428/espresso-how-do-i-assert-if-a-particular-activity-is-launched-when-i-click-on-a
    /// StackOverflow question, titled: How do I assert an activity in Espresso after I click on a view item? Asked Feb 2 2017
